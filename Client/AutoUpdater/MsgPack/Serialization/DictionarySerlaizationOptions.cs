...
#else
				return System.Threading.Volatile.Read( ref this._omitNullEntry );
#endif // !FEATURE_CONCURRENT
			}
			set
			{
...
#else
                System.Threading.Volatile.Write( ref this._omitNullEntry, value );
#endif // !FEATURE_CONCURRENT
			}
		}
...
#else
				return System.Threading.Volatile.Read( ref this._keyTransformer );
#endif // !FEATURE_CONCURRENT
			}
			set
			{
...
#else
                System.Threading.Volatile.Write( ref this._keyTransformer, value );
#endif // !FEATURE_CONCURRENT
			}
		}
