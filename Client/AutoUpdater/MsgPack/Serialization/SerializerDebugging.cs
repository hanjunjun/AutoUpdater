...
namespace MsgPack.Serialization
{
	...
	static class SerializerDebugging
	{
...
#else
				return System.Threading.Volatile.Read( ref _useLegacyNullMapEntryHandling );
#endif
			}
			set
			{
...
#else
                System.Threading.Volatile.Write( ref _useLegacyNullMapEntryHandling, value );
#endif
			}
		}
		...
		{
			get { return System.Threading.Volatile.Read( ref _isNaiveAsyncAllowed ); }
			set { System.Threading.Volatile.Write( ref _isNaiveAsyncAllowed, value ); }
		}

		internal static void EnsureNaiveAsyncAllowed( object source, [CallerMemberName]string method = null )
		{
			if ( !System.Threading.Volatile.Read( ref _isNaiveAsyncAllowed ) )
			{
		...
		{
#if FEATURE_CONCURRENT
            System.Threading.Volatile.Write( ref _codeCompiler, codeCompiler );
#else
