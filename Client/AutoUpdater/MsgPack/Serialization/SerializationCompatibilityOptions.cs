...
#else
				return System.Threading.Volatile.Read( ref this._oneBoundDataMemberOrder );
#endif // !FEATURE_CONCURRENT
			}
			set
			{
...
#else
                System.Threading.Volatile.Write( ref this._oneBoundDataMemberOrder, value );
#endif // !FEATURE_CONCURRENT
			}
		}
...
#else
				return System.Threading.Volatile.Read( ref this._ignorePackabilityForCollection );
#endif // !FEATURE_CONCURRENT
			}
			set
			{
...
#else
                System.Threading.Volatile.Write( ref this._ignorePackabilityForCollection, value );
#endif // !FEATURE_CONCURRENT
			}
		}
...
#else
				return System.Threading.Volatile.Read( ref this._allowNonCollectionEnumerableTypes );
#endif // !FEATURE_CONCURRENT
			}
			set
			{
...
#else
                System.Threading.Volatile.Write( ref this._allowNonCollectionEnumerableTypes, value );
#endif // !FEATURE_CONCURRENT
			}
		}
...
#else
				return System.Threading.Volatile.Read( ref this._allowAsymmetricSerializer );
#endif // !FEATURE_CONCURRENT
			}
			set
			{
...
#else
                System.Threading.Volatile.Write( ref this._allowAsymmetricSerializer, value );
#endif // !FEATURE_CONCURRENT
			}
		}
