...
namespace MsgPack.Serialization
{
	...
	public sealed class SerializerOptions
	{
...
#else
				return System.Threading.Volatile.Read( ref this._isRuntimeGenerationDisabled );
#endif // !FEATURE_CONCURRENT
			}
			set
			{
...
#else
                System.Threading.Volatile.Write( ref this._isRuntimeGenerationDisabled, value );
#endif // !FEATURE_CONCURRENT
			}
		}
...
#else
				return System.Threading.Volatile.Read( ref this._isNonPublicAccessDisabled );
#endif // !FEATURE_CONCURRENT
			}
			set
			{
...
#else
                System.Threading.Volatile.Write( ref this._isNonPublicAccessDisabled, value );
#endif // !FEATURE_CONCURRENT
			}
		}
		...
		{
			get { return System.Threading.Volatile.Read( ref this._withAsync ); }
			set { System.Threading.Volatile.Write( ref this._withAsync, value ); }
		}
